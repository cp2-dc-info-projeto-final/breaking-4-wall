...
function envia_email($para, $assunto, $mensagem){
    ...
    try {
        ...
        $mail->Username   = 'breakingwall4@gmail.com';               //usuário SMTP
        $mail->Password   = 'idwgghtvbedxltsz';                      //senha SMTP
        ...
        $mail->setFrom('breakingwall4@gmail.com', 'Breaking4Wall');  // Adiciona o remetente
